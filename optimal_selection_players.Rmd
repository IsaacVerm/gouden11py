...
The problem with the formations is they are not explicitly defined in the rules. The best way to find out what formations are possible is to have a look at the formations used by existing players.

Regarding solutions, this looks like a lineair programming problem but let's first try to handle this manually.
