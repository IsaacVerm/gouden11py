...
random_teams_all_players <- replicate(1000,
...
# select random teams
random_teams_top_players <- replicate(100000,
...
We randomly select 100000 teams of which roughly 500 are valid. We can see a substantial amount of these teams earn more than 400 points which would certainly put them in the top 100 best teams.


# Number of teams necessary to obtain first place

Now exactly how many teams do we need to obtain the first place with a certain reliability? 